package com.cokimutai.sq_authenticator.utils;
...
public class ValidateUserInput {
    ...
    public ValidateUserInput(Context mContext){
    ...
    public boolean isInputEditTextEmailValid(TextInputEditText textInputEditText, TextInputLayout textInputLayout, String message) {
        String value = textInputEditText.getText().toString().trim();
